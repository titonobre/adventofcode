...
The total disk space available to the filesystem is _`70000000_`. To run the update, you need unused space of at least `_30000000`_. You need to find a directory you can delete that will _free up enough space_ to run the update.

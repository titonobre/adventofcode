...
Now, you can determine the total winnings of this set of hands by adding up the result of multiplying each hand's bid with its rank (`765` _ 1 + `220` _ 2 + `28` _ 3 + `684` _ 4 + `483` \* 5). So the _total winnings_ in this example are _`6440`_.
